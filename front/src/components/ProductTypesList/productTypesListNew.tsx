...
import { productTypesNew } from '~/components/ProductTypesList/productTypesNew'
...
export const ProductTypesListNew: React.FC = () => {
  ...
  return (
    <>
      <div ref={containerRef as React.RefObject<HTMLDivElement>} className={styles.productListSelectContainer}>
        {productTypesNew.map(({ image, link, name }, index) => {
          const isAvailable =
            ...
            >
              ...
              >
                <Image
                  ...
                  unoptimized={image.startsWith('/renders-landing/')}
                  onError={(e) => {
                    // Fallback to placeholder if image fails to load
                    const target = e.target as HTMLImageElement
                    target.src = 'data:image/svg+xml;base64,PHN2ZyB3aWR0aD0nNjAwJyBoZWlnaHQ9JzQwMCcgdmlld0JveD0nMCAwIDYwMCA0MDAnIHhtbG5zPSdodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2Zyc+PHJlY3Qgd2lkdGg9JzYwMCcgaGVpZ2h0PSc0MDAnIGZpbGw9JyNFMEUwRTAnLz48L3N2Zz4='
                  }}
                ></Image>
                {isAvailable ? (
